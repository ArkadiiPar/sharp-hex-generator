...
# --- LUMA HEX Data ---
luma_original_lines = [
    "00000a610a0f0d",  # заголовок вне уровней
...
# === TAB 1: Sharp Levels (оставляем без изменений) ===
# Тут твой старый код для Sharp
...
with tab2:
    ...
    if st.button("🚀 Сгенерировать LUMA HEX"):
        full_hex = generate_luma_hex(luma_inputs, luma_levels, luma_slices)
